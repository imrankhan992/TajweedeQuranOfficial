  ...
  return (
    <div className="md:px-16 px-6 text-center py-16">
     ...
     <div className="grid  md:grid-cols-4 justify-between w-full flex-auto gap-4">
     {
        learnQuran.map((item) => {
          return  (
            <div key={item.id} className="group boxShadow p-4 flex justify-between flex-col gap-3 shadow-lg min-h-[430px]  !rounded-3xl border-2 border-[#032E3C] cursor-pointer hover:bg-[#C28336]  duration-150 active:transition-transform  hover:duration-1000 hover:transition-colors">
