...
const WhatsAppButton = () => {
  const phoneNumber = "+923430262044"; // Replace with the recipient's phone number
  ...
  return (
    <div className="bottom-6 fixed left-6 z-50">
      <button
        onClick={handleClick}
        style={{
          border: "none",
        ...
        className="active:scale-95 transition-transform duration-150 hover:scale-110"
...
//       ? `https://wa.me/${phoneNumber}?text=${message}` // Mobile link
//       : `https://web.whatsapp.com/send?phone=${phoneNumber}&text=${message}`; // WhatsApp Web link
...
//       <img src="whatsapp-icon.png" alt="WhatsApp" width="50" height="50" />
//     </button>
//   );
// };
